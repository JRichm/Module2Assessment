...
const canWeDeliverTwo = (zipcode) => {
    deliveryAreaZipCodes.forEach((element, index) => {
        zipcode = deliveryAreaZipCodes[index] ? `You're in our delivery zone!` : `Sorry, we can't deliver to that address`
    });
}

console.log(canWeDeliver(84095));
